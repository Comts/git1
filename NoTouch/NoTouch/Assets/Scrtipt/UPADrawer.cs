...
public class UPADrawer : MonoBehaviour
{
	...
	//{
	//	get { return CustomImage.CurrentImg; }
	//	set { CustomImage.CurrentImg = value; }
	//}
	...
	// GETTER METHODS
	//public  Rect GetLayerPanelRect (Rect window) {
	...
	//	Texture2D _result = CalculateBlendedTex(img.layers[0]);
	...
	public static Texture2D CalculateBlendedTex(UPALayer[] _layers)
	{
		if (_layers.Length  > 0)
		{
	...
	//public  void DrawToolbar (Rect window, Vector2 mousePos) {
	...
	//public  void DrawLayerPanel (Rect window) {
