public static class Paths
{
    ...
    public const string Q_MineCount_INFO_TABLE = JSON_FILE_LOCATION + "Quest_MineCount_Text";
    public const string Q_SilverDazi_INFO_TABLE = JSON_FILE_LOCATION + "Quest_SilverDazi_Text";
