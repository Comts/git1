...
namespace telephone
{
    ...
    class BookController
    {
                ...
                else
                {
                    ...
                    switch ((eSerchCommand)Command)
                    {
                        case eSerchCommand.PhoneNumber:
                            ...
                            Index = mPhoneNumber.IndexOf(int.Parse(Console.ReadLine()));
        ...
        public void AddNum()
        {
            ...
            mPhoneNumber.Add(int.Parse(Console.ReadLine()));
