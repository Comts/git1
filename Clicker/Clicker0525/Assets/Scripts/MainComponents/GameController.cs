...
#pragma warning restore 0649
    ...
    private void Awake()
    {
        if(Instance == null)
        {
            ...
            LoadGame();
            if (Application.systemLanguage == SystemLanguage.Korean)//초창기 언어설정
            {
    ...
    public void Rebirth()
    {
        ...
        {
            Debug.Log("환생 조건이 충족되지 않았습니다.");
        }
        // 환생 가능여부 파악 -
        // Soul지급 -
        // Level array 초기화 -
        // stkill cooltime 초기화 -
        // UI초기화 (Player item,coworker) -
        // 동료 초기화 -
        // Gold초기화 -
    ...
    {
        if(mUser.Stage >0 && mUser.Stage % 10 ==0) //10턴마다 보스 나옴
        {
